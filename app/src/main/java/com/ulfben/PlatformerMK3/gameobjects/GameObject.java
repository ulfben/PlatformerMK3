...
public class GameObject {
    ...
    private static final float DEFAULT_LOCATION = 0f; //meters
    private static final float DEFAULT_HEIGHT = 1f;   //meters
    static final float DEFAULT_WIDTH = 1f;    //meters
    ...
    Bitmap mBitmap = null; //We do not own the bitmap. The BitmapPool will recycle it!
    ...
    GameObject(final String sprite, float width, float height){
        super();
    ...
    private static boolean isAABBOverlapping(final GameObject a, final GameObject b){
    ...
    static boolean getOverlap(final GameObject a, final GameObject b, final PointF overlap) {
        overlap.x = 0.0f;
        overlap.y = 0.0f;
    ...
    private float left(){ return x; }
    private float right(){ return x + width; }
    private float top(){ return y; }
